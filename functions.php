...
function migrate_feature_images_to_product_gallery() {
...
add_action('init', function () {
    ...
    migrate_feature_images_to_product_gallery(); // ✅ GALLERY
