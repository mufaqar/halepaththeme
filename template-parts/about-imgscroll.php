...
<section class="max_content mt-14 py-8">
    <div class="container mx-auto px-4 flex items-center md:flex-row flex-col gap-[70px]">
        <!-- LEFT: IMAGES -->
        <div class="md:w-1/2 relative w-full">
            <div class="overflow-hidden h-[467px]" id="imageContainer">
                <?php foreach ($images as $index => $img): ?>
                    <figure
                        class="absolute w-full rounded-2xl overflow-hidden h-[467px] image-slide <?php echo $index === 0 ? 'block' : 'hidden'; ?>"
                        data-index="<?php echo $index; ?>">
                        <img src="<?php echo esc_url($img); ?>" alt="Image <?php echo $index + 1; ?>"
                ...
                <figure>
                    <img src="<?php echo esc_url($images[0]); ?>"
                        class="w-[80%] mx-auto h-[467px] absolute z-[-1] scale-105 -top-10 rounded-3xl left-1/2 -translate-x-1/2"
                        alt="" />
                </figure>

                <figure>
                    <img src="<?php echo esc_url($images[1]); ?>"
                        class="w-[90%] mx-auto h-[467px] absolute z-[-1] scale-105 -top-5 rounded-3xl left-1/2 -translate-x-1/2"
                        alt="" />
                </figure>
            </div>
        ...
        <div class="relative md:w-1/2">
            ...
            <div
                class="absolute right-0 left-3 bottom-0 top-[60%] bg-gradient-to-t from-white/90 via-white/80 to-transparent">
            </div>
        </div>
